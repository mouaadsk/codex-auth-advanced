...
import {
  configureVsllmDashboard,
  maybeHandleVsllmDashboardConfig,
  parseVsllmDashboardConfigArgs
} from "./cli-vsllm-dashboard.mjs";
import {
...
export function createCliService({
  ...
  return {
    ...
    maybeHandleVsllmDashboardConfig: (argv) => maybeHandleVsllmDashboardConfig(argv, { syncApiKeySpendLimits }),
