...
export function responseStopReason(response, hasToolUse) {
...
export function responseStopSequence(response) {
...
export class ClaudeResponsesStreamState {
...
export function nextSseBoundary(buffer) {
