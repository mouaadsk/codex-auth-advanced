...
The codex-everywhere and tcdmx templates also sanitize compact requests before forwarding them: the proxy removes encrypted reasoning blobs that those providers cannot decrypt after a backend switch. Normal chat requests stay pass-through.
